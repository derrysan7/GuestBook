    ...
    ?>
            <div class="panel panel-default">
                ...
                <div class="panel-body fixed-panel" >
                    <div class="float-left" class="col-md-3">
                          <img class="" src="user_images/<?php echo ($row['gambar']) ?>" style="width:100px;" />
                    </div>
  ...
  if($stmt->rowCount()>0)
  {
   while($row=$stmt->fetch(PDO::FETCH_ASSOC))
   {
    ...
    ?>
     ...
     <a href="<?php echo ($row['url']) ?>"><img src="user_images_berita_sidelink/<?php echo ($row['gambar']) ?>" style="width:100%;" /> </a>
    <?php
   }
  }
  else
  ...
  if($stmt->rowCount()>0)
  {
   ...
   while($row=$stmt->fetch(PDO::FETCH_ASSOC))
    ...
    ?>
        ...
        <img src="user_images_berita_carousel/<?php echo ($row['gambar']) ?>" alt="pic" width="460" height="345">
      </div>
    <?php
    $isFirst = false;
    } else {        
