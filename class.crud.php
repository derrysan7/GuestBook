...
class crud
{
 ...
 public function create($uname,$umail,$upass,$ufullname,$uperm)
 {
  try
  {
   ...
   $stmt = $this->db->prepare("INSERT INTO users(userName,userEmail,userPass,fullname,kodePermission) 
                                                   VALUES(:uname, :umail, :upass, :ufullname,:uperm)");
