...
if(isset($_POST['btn-del']))
{
 ...
 unlink("user_images_berita_carousel/".$gambar);
 $crud->delete_carousel($id_del);
 header("Location: delete-berita-carousel.php?deleted"); 
}
...
if(isset($_GET['delete_id']))
{
 ?>
   <form method="post">
    ...
    <a href="listberita-carousel.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>  
 <?php
}
else
