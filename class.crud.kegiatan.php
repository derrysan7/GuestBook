...
class crud
{
 ...
 public function create($buserid,$bjudul,$bdeskripsi,$userpic,$bnamapen)
 {
  try
  {
   $stmt = $this->db->prepare("INSERT INTO kegiatan(userId,tanggaldib,judul,deskripsi,gambar,namapen) 
    ...
    ?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div>
                    <a href="DetailBerita.html"><h3><?php print($row['judul']); ?></h3></a>
                    </div>
                ...
                <div class="panel-body fixed-panel" >
                    <div class="float-left" class="col-md-3">
                        <img class="float responsive" src="user_images_kegiatan/<?php echo ($row['gambar']) ?>" style="width:100px" />
                    </div>
