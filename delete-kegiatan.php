...
if(isset($_POST['btn-del']))
{
  if ($userRow['userId'] == $userId){
       ...
       unlink("user_images_kegiatan/".$gambar);
       $crud->delete($id_del);
       header("Location: delete-kegiatan.php?deleted"); 
  }else {
...
<link rel="stylesheet" href="stylekegiatan.css" type="text/css">
...
if(isset($_GET['delete_id']))
{
 ?>
   <form method="post">
    ...
    <a href="listkegiatan.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>  
 <?php
}
else
